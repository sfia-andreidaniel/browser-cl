...
function Executor( apiHostNameAndPort, controller, dataDir ) {
    ...
    me.next = function( callback ) {
        ...
        tasker.sync( function() {
            ...
            ( function( task ) {
                ...
                taskDir = dataDir + "/" + ( new Date() ).getTime() + "-" + ~~( 1000 * Math.random() );
        ...
        tasker.sync( function() {
            ...
            me.on( 'job-status', "5. downloading the file from the storage node in it's transcoding directory" );
        ...
        tasker.sync( function() {
            ...
            ( function( task ) {
                ...
                rollbacks.transcoder.onStatus( function( status ) {
                    ...
                    me.on( "job-status", "7. [transcoding] " + second + " seconds processed" );
        ...
        tasker.sync( function() {
            ...
            me.on( 'job-status', "8. testing if transcoded file exists..." );
