...
exports.Api = function() {
    ...
    me.handleUpload = function( filePacket, callback ) {
        ...
        console.log( "Sending broadcast-store event to all storage nodes, for size: ", filePacket.fileSize );
        ...
        tasker.sync( function() {
            ...
            ( function( task ) {
                ...
                if ( nodes.length == 0 ) {
                    task.on( 'error', "No storage nodes were capable to store your file!" );
                    return;
                }
