...
var Task = function( async, index, callback, success, error, taskOwner ) {
    ...
    me.bind( 'complete', function() {
        ...
        if ( me.complete || me.success || me.error || !me.started ) {
            // console.log( "Task.cancel(complete):" + index + ", ", me.started, me.error, me.success, me.complete );
            return;
        }
        ...
        if ( ( myGroup && myGroup.allAre && myGroup.allAre('complete', true ) && myGroup.last && myGroup.last.next && !myGroup.last.next.started ))
            setTimeout( function() {
