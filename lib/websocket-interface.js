            ...
            case request.resourceURL.path == '/api/' && additionalPaths.indexOf( '/api/' ) >= 0:
                ...
                tasker.bind( 'file-packet', function( data ) {
                    ...
                    if ( !(data instanceof Object) || !data.name || !data.size || data.size <= 0 ) {
                        ...
                        filePacket = data;
                        console.log( "Receiving file: ", filePacket.name, " of size: ", filePacket.size );
                ...
                connection.on( 'message', function( event ) {
                    switch ( event.type ) {
                        case 'utf8':
                            ...
                            break;
                        case 'binary':
                            error("This webservice does not support binary websocket frames!");
                            break;
                        default:
                ...
                tasker.run( function() {
                    ...
                    console.log( "File transfer error: " + ( error || "Unknown error" ) );
                } );
