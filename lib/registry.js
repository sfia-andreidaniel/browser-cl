        ...
        if ( !apiAddress ) {
            ...
            tasker.sync( function() {
                ...
                ( function( task ) {
                    ...
                    conn.query( "UPDATE uploads_tasks SET status='" + status + "' WHERE id=" + config.taskId + " LIMIT 1", function( err, result ) {
    ...
    */
    ...
    me.remoteFind = function( apiAddress, skip, limit, filter, callback ) {
        ...
        tasker.sync( function() {
            ...
            var targetURL = 'http://' + apiAddress + '/query/?q=' + encodeURIComponent( JSON.stringify( filter ) ) + "&skip=" + skip + "&limit=100";
