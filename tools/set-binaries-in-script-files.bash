...
echo "bin/patch account nodejs"
bin/patch account nodejs > /dev/null 2>&1
echo "bin/patch api bash"
bin/patch api bash > /dev/null 2>&1
echo "bin/patch firewall nodejs"
bin/patch firewall nodejs > /dev/null 2>&1
echo "bin/patch network nodejs"
bin/patch network nodejs > /dev/null 2>&1
